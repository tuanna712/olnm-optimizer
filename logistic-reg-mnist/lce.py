...
# --- Comparison Plot ---
import numpy as np  
def smooth_history(history, window_size=10):
...
plt.savefig("imgs/png/figure-3b.png")
plt.savefig("imgs/pdf/figure-3b.pdf", bbox_inches='tight')
plt.savefig("imgs/svg/figure-3b.svg", bbox_inches='tight')
